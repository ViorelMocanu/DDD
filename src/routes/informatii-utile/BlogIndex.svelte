...
<svelte:head>
  ...
  <meta
    name="description"
    content="Citește toate articolele scrise de echipa DeDeDe în legătură cu felul cum ai putea și tu să scapi de 🐜 gândaci, 🐀 șobolani, 🦟 ploșnițe sau alți ☠️ dăunători." />
  ...
  <meta property="og:image" content="https://dedede.ro/images/og-image-blogindex.jpg" />
  <meta property="og:image:alt" content="DeDeDe.ro - Articole utile despre Dezinfecție, Dezinsecție sau Deratizare" />
...
<section class="Hero ContentPage" role="banner">
  <div class="HeroContainer IndexHeroContainer LimitWidth">
    ...
    <p class="HeroText">
      Articole folositoare dacă vrei să scapi de 🐜 gândaci, 🐀 șobolani, 🦟 ploșnițe sau alți ☠️ dăunători.
    </p>
  </div>
</section>
