...
<div class="ArticleContainer" itemscope itemtype="https://schema.org/Article">
  ...
  <section class="BigArticle LimitWidth">
    ...
    <div class="ArticlePreMeta">
      <p>
        Articol scris pe <strong itemprop="datePublished" content={frontmatter.date}
          ><DataCitibila dataNecitibila={frontmatter.date} eScurta={false} /></strong>
      </p>
    ...
    {#if frontmatter.author}
      <p class="ArticleAuthor">
        Articol scris de
        <strong itemprop="author">{frontmatter.author}</strong>
      </p>
    {/if}
