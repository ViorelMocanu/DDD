...
<svelte:head>
	<title>Politica de cookies a site-ului DeDeDe.ro</title>
	<meta name="description" content="Află politica de cookies folosită pentru site-ul DeDeDe.ro și pentru serviciile noastre de Dezinfecție, Dezinsecție și Deratizare." />
	<link rel="canonical" href="{settings.origin}{request.permalink}" />
	<meta name="og:title" content="Politica de cookies a site-ului DeDeDe.ro" />
	<meta property="og:description" content="Află politica de cookies folosită pentru site-ul DeDeDe.ro și pentru serviciile noastre de Dezinfecție, Dezinsecție și Deratizare." />
...
<article class="ArticleContainer" itemscope itemtype="https://schema.org/Article">
	<main class="BigArticle LimitWidth">
		<ol class="Breadcrumbs" itemscope itemtype="https://schema.org/BreadcrumbList">
			...
			<li class="BreadcrumbItem" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
				<span class="BreadcrumbText" itemprop="name">Cookies</span>
				<span class="ScreenReaders" itemprop="position">2</span>
			</li>
		</ol>
		<h1 class="BigArticleTitle" itemprop="headline">Politica de cookies</h1>
		...
		<p class="BigArticleIntro">Sigur ai tot auzit despre <q><em>cookies</em></q> și despre faptul că apar pe site-uri. Hai să vedem ce sunt exact și cum te afectează pe tine.</p>
		<div class="ArticleBody" itemprop="articleBody">
			...
			<h2>La ce sunt folosite cookies?</h2>
			<p>Aceste fisiere fac posibila recunoasterea terminalului utilizatorului si prezentarea catre acesta a unui continut adaptat preferintelor sale. Cookies asigura utilizatoriului o experienta placuta de navigare si sustin eforturile Gyo Cleaning pentru a oferi servicii confortabile utilizatorului, cum ar fi: preferintele in materie de confidentialitate online, cosul de cumparaturi sau publicitate relevanta. Cookies sunt utilizate in pregatirea unor statistici anonime agregate care ne ajuta sa intelegem modul in care un utilizator beneficiaza de paginile noastre web, permitandu-ne imbunatatirea structurii si continutului acestora.</p>
			<h2>Ce cookies folosim?</h2>
			<p>Folosim doua tipuri de cookies:</p>
			<ul>
			...
			<h2>Cum sunt folosite cookies de catre acest site?</h2>
			<p>O vizita pe acest site poate plasa urmatoarele tipuri de cookies, in functie de consimtamantul exprimat de utilizator:</p>
			<ul>
				<li>Cookie-uri de performanta a site-ului;</li>
				<li>Cookie-uri de analiza a vizitatorilor;</li>
			</ul>
			<p>Cookies care, din punct de vedere tehnic, nu sunt obligatorii a fi stocate pe terminalul utilizatorului, vor fi folosite doar daca utilizatorul isi exprima consimtamantul expres si neechivoc in legatura cu acestea. Utilizatorul isi poate retrage consimtamantul in orice moment prin modificarea setarilor aferente browser-ului utilizat.</p>
			<p>Detalii privind modificarea setarilor browserelor puteti gasi pe website-urile dezvoltatorilor browserelor prezentate mai jos:</p>
			<ul>
				<li>
					<a
						rel="external nofollow noreferrer noodp"
						target="_blank"
						href="https://support.google.com/chrome/answer/114836?hl=en&co=GENIE.Platform%3DDesktop">Google Chrome</a>
				</li>
				<li>
					<a
						rel="external nofollow noreferrer noodp"
						target="_blank"
						href="https://support.mozilla.org/en-US/products/firefox/privacy-and-security">Mozilla Firefox</a>
				</li>
				<li>
					<a
						rel="external nofollow noreferrer noodp"
				...
				<li>
					<a
						rel="external nofollow noreferrer noodp"
						target="_blank"
						href="https://help.opera.com/en/latest/security-and-privacy/">Opera</a>
				</li>
				<li>
					<a
						rel="external nofollow noreferrer noodp"
						target="_blank"
						href="https://support.apple.com/en-gb/guide/safari/sfri35610/mac">Apple Safari</a>
				</li>
			</ul>
			<p>In cazul in care browserul nu este gasit in lista de mai sus, va rugam sa vizitati site-ul dezvoltatorului respectivului browser.</p>
			<h2>Contin cookies date personale?</h2>
			...
			<h2>Retentia si stergerea cookies</h2>
			...
			<ul>
				...
				<li>Asigurati-va ca aveti browserul mereu updatat.</li>
			</ul>
			...
			<ul>
				<li><a rel="external nofollow noreferrer noodp" target="_blank" href="http://support.microsoft.com/kb/196955">Cookie settings in Internet Explorer</a></li>
				<li>
					<a
						rel="external nofollow noreferrer noodp"
						target="_blank"
				...
				<li><a rel="external nofollow noreferrer noodp" target="_blank" href="http://support.apple.com/kb/PH5042">Cookie settings in Safari</a></li>
			</ul>
			<p>Pentru setarile cookie-urilor generate de terti, puteti consulta si site-ul: <a href="http://www.youronlinechoices.com/ro/">http://www.youronlinechoices.com/ro/</a></p>
			<h2>Linkuri utile</h2>
			<p>Daca doriti sa afli mai multe infromatii despre cookie-uri si la ce sunt utilizate, recomandam <a rel="external nofollow noreferrer noodp" target="_blank" href="http://www.youronlinechoices.com/ro/">http://www.youronlinechoices.com/ro/</a></p>
			<p><a href="/">DeDeDe.ro</a> folosește serviciile următoarelor terțe părți în scopul oferirii de funcționalități, pentru analiză și pentru publicitate. Este posibil ca aceste terțe părți să seteze și să folosească cookie-uri și/sau tehnologii similare pe website-urile și în aplicațiile operate de <a href="/">DeDeDe.ro</a>, precum și pe website-uri și în aplicații altele decât cele operate de Braunstore.ro.</p>
			<p>Pentru mai multe detalii, consultați politicile de protecție a datelor precum și ghidurile de administrare a preferințelor utilizatorilor și posibilitățile de dezactivare oferite de companiile care gestionează aceste servicii, după caz.</p>
			<dl>
				<dt>Google Analytics</dt>
				<dd>
					<ul>
						<li><strong>Categorie:</strong> Analiză</li>
						<li><strong>Scop:</strong> Web analytics</li>
						<li>
							<strong>Politici:</strong>
							<a
								rel="external nofollow noreferrer noodp"
								target="_blank"
