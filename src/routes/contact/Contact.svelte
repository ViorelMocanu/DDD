...
<svelte:head>
  ...
  <meta
    name="description"
    content="Programează-te acum la Dezinfecție, Dezinsecție sau Deratizare! Scapă de 🐜 gândaci, 🐀 șobolani, 🦟 ploșnițe, 🦠 viruși sau alți ☠️ dăunători! București + Ilfov" />
  ...
  <meta property="og:image" content="https://dedede.ro/images/og-image-contact.jpg" />
  <meta property="og:image:alt" content="DeDeDe.ro - Programează-te la Dezinsecție, Dezinfecție sau Deratizare" />
  ...
  <div class="HeroContainer LimitWidth">
    ...
    <div class="ContactHeroContainer">
      <div class="HeroContent">
        ...
        <p class="HeroText">
          Vrei să afli cât te costă o deratizare, o dezinfecție sau o dezinsecție? Vrei să scapi de 🐜 gândaci, 🐀
          șobolani, 🦟 ploșnițe, 🦠 viruși sau alți ☠️ dăunători? Dă-i datele tale lui DeDeDe în formularul de mai jos
          și te va contacta în cel mai scurt timp!
        </p>
      </div>
      <img
        class="HeroImage"
