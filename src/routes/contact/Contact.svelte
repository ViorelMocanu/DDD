<script>
  ...
  let result = null,
    ...
    utm_source = urlParams.has('utm_source') ? urlParams['utm_source'] : '',
    utm_medium = urlParams.has('utm_medium') ? urlParams['utm_medium'] : '',
    utm_term = urlParams.has('utm_term') ? urlParams['utm_term'] : '',
    utm_content = urlParams.has('utm_content') ? urlParams['utm_content'] : '',
    utm_campaign = urlParams.has('utm_campaign') ? urlParams['utm_campaign'] : '',
    gclid = urlParams.has('gclid') ? urlParams['gclid'] : '',
    side_name = '',
    side_telephone = '',
    side_email = '',
    side_tip = '',
